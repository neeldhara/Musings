...
- the edge to the $\ell$-th vertex on $P$ is active only if there is a bunny on at least one of the literals present in the clause $C_{\ell-1}$;
...
Thanks to [Daniel](https://twitter.com/lokshtanov) for sharing this reduction!
:::

To round this off: more questions :)
...
Please feel free to share your thoughts in the comments here, or continue the conversation on Twitter!